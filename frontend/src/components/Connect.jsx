...
const Connect = () =>{
  ...
  return(
    <motion.div
      ...
      viewport={{ once: false }}>
      <div className="w-full h-220 flex flex-col mt-40">
        <p className="w-full h-fit text-center text-bold text-5xl bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent " >Let's Collaborate</p>
        ...
        <div className="w-full h-full flex">
          <div className="flex w-[50%] h-full flex-col px-24" >
            ...
            <div className="w-120 h-fit flex border border-gray-700 border-l-4 border-l-blue-500  mt-10  pr-2 py-2 transition-all duration-200 rounded-lg hover:translate-x-1.5" >
          ...
          <div className="flex w-[50%] h-full flex-col px-24" >
            ...
            <form className="flex flex-col gap-8" onSubmit={connectDetails}>
              ...
              <button className="w-full h-fit py-2 px-4 bg-gradient-to-r from-pink-400 to-purple-400  rounded-2xl font-mono text-3xl text-bold flex justify-center items-center transition-all duration-500 hover:scale-110" ><FcInvite className="text-blue-500 mr-4" size={30}/>Invite</button>
            </form>
          </div>
        </div>
