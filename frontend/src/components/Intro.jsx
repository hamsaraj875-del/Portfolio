            ...
            <div className="h-50 flex flex-col justify-between">
              ...
              <div className="w-full flex gap-6">
                <a
                  ...
                  className="inline-flex hover:scale-105 transition px-4 py-2 justify-center  items-center bg-gradient-to-r from-black to-purple-600 text-white font-bold rounded-xl "
                  target="_blank"
                ...
                <a
                  ...
                  className="inline-flex px-4 py-2 justify-center hover:scale-105 transition  items-center bg-gradient-to-r from-black to-purple-600  text-white font-bold rounded-xl"
                  target="_blank"
                  rel="noopener noreferrer"
                >
