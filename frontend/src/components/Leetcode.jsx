        ...
        <hr className="bg-gradient-to-r from-purple-500 to-blue-500 mt-10 ml-30 mr-30 h-1"></hr>
          <div className="flex flex-col h-fit  py-12 justify-center items-center  bg-[#09152d] mt-12 ml-30 mr-30 rounded-xl">
            ...
            <div className="flex  w-fit mt-10 gap-18">
              <button onClick={(e)=>setCodetab("leetcode")} className={`border border-gray-600 rounded-xl px-4 py-2 hover:cursor-pointer  shadow ${codeTab === "leetcode"?'shadow-amber-100':''} hover:shadow-amber-100`}>
                Leetcode
              </button>
              <button onClick={(e)=>setCodetab("github")} className={`border border-gray-600 rounded-xl hover:cursor-pointer px-4 py-2 shadow ${codeTab === "github"?'shadow-amber-100':''} hover:shadow-amber-100`}>
                Github
              </button>
            </div>
            {loader && <Loader/>}
              ...
              <div className="w-full">
                <div className="mt-10" >
                  <div className="text-2xl w-full flex justify-center items-center mt-6 gap-4">
                    <SiLeetcode size={30}/>
                    <p className="mr-6">{leetcodeData.message.data.matchedUser.profile.realName}</p>  
                    <FaRankingStar className="text-red-400" size={30}/>
                    <p className="text-red-400" >{leetcodeData.message.data.matchedUser.profile.ranking}</p>
                  </div>   
                ...
                <div className="w-full h-fit flex flex-col justify-center items-center gap-6 mt-8">
                  ...
                  <div className="w-full h-fit">
                    <a target="_blank" href="https://leetcode.com/u/HamsarajVC/" className="w-fit h-fit px-4 py-2 border border-gray-700 rounded-xl ml-40 cursor-pointer">View Leetcode Profile</a>
                  </div>
                </div>
              </div>
            )}
              ...
              {githubData && codeTab==="github" && (
                <div className="w-full h-150 flex flex-col gap-8">
                  <div className="flex justify-center items-center h-fit mt-10 gap-10 ">
                    <img className="w-24 h-24 rounded-full mr-6" src={githubData.message.avatar_url}></img>
                    <div>
                  ...
                  <div className="w-full h-fit" >
                    <a target="_blank" href="https://github.com/hamsaraj875-del" className="w-fit h-fit px-4 py-2 border border-gray-700 rounded-xl ml-40 cursor-pointer">View Github Profile</a>
                  </div>
                </div>
              )}
            </motion.div>
