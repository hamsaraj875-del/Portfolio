  ...
  return (
    ...
    >
      <div className="w-full min-h-screen flex flex-col justify-center items-center mt-20 md:mt-40 px-4">
        ...
        <div className="w-full flex flex-col lg:flex-row">
          <div className="flex w-full lg:w-[50%] flex-col px-6 md:px-12 lg:px-24">
            ...
            <p className="text-gray-400 mb-10">
              I'm always eager to connect with fellow developers, innovators,
              and creators to exchange ideas, collaborate on exciting projects,
              and turn extraordinary concepts into reality.
            </p>
            <div className="group w-full h-fit flex border border-gray-700 border-l-4 border-l-blue-500  mt-6 md:mt-10  pr-2 py-2 transition-all duration-200 rounded-lg hover:translate-x-1.5">
              <div className="px-4 py-1 flex justify-center items-center">
                <HiOutlineMailOpen
              ...
              <div>
                ...
                <p className="w-full h-fit text-gray-400">
                  hamsaraj531@gmail.com
                </p>
              </div>
            </div>
            <div className="w-full h-fit flex border border-gray-700 border-l-4 border-l-blue-500  mt-6 md:mt-10  px-1 py-2 transition-all duration-200 rounded-lg hover:translate-x-1.5">
              <div className="px-4 py-1 flex justify-center items-center">
                <FaPhoneVolume className="text-purple-600 mr-2" size={30} />
              </div>
              <div>
            ...
            <div className="w-full h-fit flex border border-gray-700 border-l-4 border-l-blue-500  mt-6 md:mt-10  px-1 py-2 transition-all duration-200 rounded-lg hover:translate-x-1.5">
              <div className="px-4 py-1 flex justify-center items-center">
                <FaLocationArrow className="text-purple-600 mr-2" size={30} />
              </div>
              <div>
                <p className="w-full h-fit">Location</p>
                <p className="w-full h-fit text-gray-400">
                  Dayananda Sagar College of Engineering Shavige Malleshwara
                  Hills, 91st Main Rd 1st Stage, Kumaraswamy Layout Bengaluru,
                  Karnataka 560078
                </p>
              </div>
            </div>
          </div>
          <div className="flex w-full lg:w-[50%] flex-col px-6 md:px-12 lg:px-24 mt-12 lg:mt-0">
            <p className="w-full h-fit text-lg md:text-xl py-4"> Reach Out </p>
            <p className="text-gray-400 mb-10">
        ...
        {res.length != 0 && (
          <div className="text-base md:text-lg text-green-400 text-center flex flex-col justify-center items-center my-10 px-4">
            <FaRegHandshake
              size={50}
              className="text-green-400 animate-pulse mr-4"
            />
            <p>{res}</p>
          </div>
        )}
